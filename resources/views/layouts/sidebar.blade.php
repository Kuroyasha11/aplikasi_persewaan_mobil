    ...
    <div id="sidebar-scrollbar">
        <nav class="iq-sidebar-menu">
            <ul id="iq-sidebar-toggle" class="iq-menu">
                ...
                <li class="{{Request::is('roles*') || Request::is('permissions*') || Request::is('users*') ? 'active' : ''}}">
                    <a href="#userinfo" class="iq-waves-effect" data-toggle="collapse"
                       aria-expanded="{{Request::is('roles*') || Request::is('permissions*') ? 'true' : 'false'}}"><span
                            class="ripple rippleEffect"></span><i
                            class="las la-user-tie iq-arrow-left"></i><span>User</span><i
                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>
                    <ul id="userinfo" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle" style="">
                        <li class="{{Request::is('roles*') ? 'active' : ''}}"><a href="/roles"><i
                                    class="las la-user-shield"></i>Roles</a></li>
                        <li class="{{Request::is('permissions*') ? 'active' : ''}}"><a href="/permissions"><i
                                    class="las la-user-tag"></i>Permissions</a></li>
                        <li class="{{Request::is('users*') ? 'active' : ''}}"><a href="/users"><i
                                    class="las la-th-list"></i>User List</a></li>
                ...
                {{--                       aria-expanded="false"><i--}}
                {{--                            class="ri-archive-drawer-line iq-arrow-left"></i><span>Forms Wizard</span><i--}}
                {{--                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>--}}
                ...
                {{--                       aria-expanded="false"><i class="ri-pantone-line iq-arrow-left"></i><span>Extra Pages</span><i--}}
                {{--                            class="ri-arrow-right-s-line iq-arrow-right"></i></a>--}}
